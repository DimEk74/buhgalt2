        ...
        <div id="car-stage" class="relative w-full h-48 sm:h-56 rounded-2xl border border-[#354251] overflow-hidden shadow-2xl mb-5 bg-black">
          ...
          <div id="explosion-fireball" class="absolute top-16 left-1/2 w-28 h-28 z-35 pointer-events-none opacity-0 flex items-center justify-center">
            <svg viewBox="0 0 100 100" class="w-full h-full">
              <radialGradient id="fireGrad2" cx="50%" cy="50%" r="50%">
              ...
              <path d="M50 5 Q65 25 85 15 Q80 40 95 50 Q75 65 85 90 Q60 80 50 95 Q40 80 15 90 Q25 65 5 50 Q20 40 15 15 Q35 25 50 5 Z" fill="url(#fireGrad2)"/>
